<template>
  <div class="flex flex-col gap-2">
    ...
    <ul v-if="publicChannelStore.channels.value.length !== 0" class="overflow-y-scroll bg-white pb-5 dark:bg-slate-950">
     <li 
      v-for="channel in publicChannelStore.channels.value"
      :key="channel.id"
