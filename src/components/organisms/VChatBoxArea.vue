<template>
  <ul
    ...
    class="flex flex-col gap-8 overflow-y-scroll border-b border-b-indigo-200 
    bg-gray-100 p-5 dark:border-b-slate-800 dark:bg-slate-900"
  >
    <VChatBalloon
    ...
    <p
      ...
      class="rounded-md border border-gray-300 bg-gray-200 p-3 text-center 
      text-sm text-gray-500 dark:border-gray-700 dark:bg-slate-800"
    >
